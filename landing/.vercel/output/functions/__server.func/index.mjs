...
import { a as NodeResponse, i as defineLazyEventHandler, n as HTTPError, o as toNodeHandler, t as H3Core } from "./_libs/h3+rou3+srvx.mjs";
...
var _lazy_4yeGkY = defineLazyEventHandler(() => import("./_chunks/renderer-template.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_4yeGkY
	};
	return ((_m, p) => {
		return {
			data,
